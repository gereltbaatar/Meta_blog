...
export const BlogAllPostCard = ({
  ...
  return (
    <div className="max-w-[392px] h-[498px] w-full border border-solid border-[#E8E8EA] rounded-xl p-4 flex flex-col gap-4 hover:shadow-md hover:border-[rgb(207,207,207)]">
